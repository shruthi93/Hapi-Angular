...
var loginPage_config = {
    description: 'Angular Quickstart App Index',
    notes: 'The main page for the Angular quickstart app',
    handler: {
        file: `${__dirname}/app/login/login.component.html`
...
var employee_config = {
    ...
    notes: 'The main page for the Angular quickstart app',
    handler: {
        file: `${__dirname}/app/employee/employee.component.html`
...
//     notes: 'The main page for the Angular quickstart app',
//     handler: {
//         file: `${__dirname}/app/login/login.component.js`
...
var app_files = [
    ...
    'app/employee/employee.component.js',
